...
func (fs *apifunctions) OptionChainGreeksFunction(req OptionChainGreeksRequestBody) (optionChainGreeksResponse map[string]interface{}, statusCode string, err error) {
	...
	resp, err := http.Post(option_chain_greeks_url, "application/json", bytes.NewBuffer(jsonPayload))
	if err != nil {
		return nil, "500", fmt.Errorf("HTTP request failed: %w", err)
	}
	defer resp.Body.Close()
	...
	if err := json.Unmarshal(body, &optionChainGreeksResponse); err != nil {
		return nil, "500", fmt.Errorf("failed to parse response: %w", err)
	}
...
func (fs *apifunctions) PlaceAMOFunction(req PlaceAMORequestBody) (placeAMOResponse map[string]interface{}, statusCode string, err error) {
	...
	resp, err := http.Post(place_amo_url, "application/json", bytes.NewBuffer(jsonPayload))
	if err != nil {
		return nil, "500", fmt.Errorf("HTTP request failed: %w", err)
	}
	defer resp.Body.Close()
	...
	if err := json.Unmarshal(body, &placeAMOResponse); err != nil {
		return nil, "500", fmt.Errorf("failed to parse response: %w", err)
	}
...
func (fs *apifunctions) ModifyAMOFunction(req ModifyAMORequestBody) (modifyAMOResponse map[string]interface{}, statusCode string, err error) {
	...
	resp, err := http.Post(modify_amo_url, "application/json", bytes.NewBuffer(jsonPayload))
	if err != nil {
		return nil, "500", fmt.Errorf("HTTP request failed: %w", err)
	}
	defer resp.Body.Close()
	...
	if err := json.Unmarshal(body, &modifyAMOResponse); err != nil {
		return nil, "500", fmt.Errorf("failed to parse response: %w", err)
	}
...
func (fs *apifunctions) BasketOrderFunction(req BasketOrderReqBody) (basketOrderResponse map[string]interface{}, statusCode string, err error) {
	...
	resp, err := http.Post(basket_order_url, "application/json", bytes.NewBuffer(jsonPayload))
	if err != nil {
		return nil, "500", fmt.Errorf("HTTP request failed: %w", err)
	}
	defer resp.Body.Close()
	...
	if err := json.Unmarshal(body, &basketOrderResponse); err != nil {
		return nil, "500", fmt.Errorf("failed to parse response: %w", err)
	}
...
func (fs *apifunctions) CombinedHoldingsFunction(req BaseRequest) (combinedHoldingsResponse map[string]interface{}, statusCode string, err error) {

	jsonPayload, err := json.Marshal(req)
	if err != nil {
		return nil, "500", fmt.Errorf("failed to marshal payload: %w", err)
	}
	resp, err := http.Post(combined_holdings_url, "application/json", bytes.NewBuffer(jsonPayload))
	if err != nil {
		return nil, "500", fmt.Errorf("HTTP request failed: %w", err)
	}
	defer resp.Body.Close()
	...
	if err := json.Unmarshal(body, &combinedHoldingsResponse); err != nil {
		return nil, "500", fmt.Errorf("failed to parse response: %w", err)
	}
